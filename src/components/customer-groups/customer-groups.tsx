...
import { useDeleteCustomerGroup, useGetCustomerGroups } from "./queries";
import { GenericObject } from "@/types";

const rootUrl = URLS.CUSTOMER_GROUPS;
...
export function CustomerGroups() {
	...
	const { data, refetch } = useGetCustomerGroups({ page, pageSize });
	const { mutate: deleteFn, isLoading: isDeleting } = useDeleteCustomerGroup();
	...
	return (
		<>
			<Box bgColor='#ffffff' borderRadius='10px'>
				...
				>
					<Text>Customer Group List</Text>
					<Button
						as='a'
						href={URLS.CUSTOMER_GROUPS_CREATE}
						variant='outline'
						colorScheme='blue'
					>
						Add Customer Group
