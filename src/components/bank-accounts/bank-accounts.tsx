...
import { useDeleteBankAccount, useGetBankAccounts } from "./queries";
...
export function BankAccounts() {
	...
	const { data, refetch } = useGetBankAccounts({ page, pageSize });
	const { mutate: deleteFn, isLoading: isDeleting } = useDeleteBankAccount();
