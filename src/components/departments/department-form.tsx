...
export function DepartmentForm(props: Props) {
	...
	const { mutate: createFn, isLoading: isCreating } = useCreateDepartment();
	const { mutate: updateFn, isLoading: isUpdating } = useUpdateDepartment();
	const { data } = useGetDepartmentDetail({
		id: props.id || "",
