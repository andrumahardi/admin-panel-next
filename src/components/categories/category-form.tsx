...
export function CategoryForm(props: Props) {
	...
	const { mutate: createFn, isLoading: isCreating } = useCreateCategory();
	const { mutate: updateFn, isLoading: isUpdating } = useUpdateCategory();
	const { data } = useGetCategoryDetail({
		id: props.id || "",
