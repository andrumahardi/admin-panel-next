...
export function TypeAccountForm(props: Props) {
	...
	const { mutate: createFn, isLoading: isCreating } = useCreateTypeAccount();
	const { mutate: updateFn, isLoading: isUpdating } = useUpdateTypeAccount();
	const { data } = useGetTypeAccountDetail({
		id: props.id || "",
