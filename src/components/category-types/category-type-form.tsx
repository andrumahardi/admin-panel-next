...
export function CategoryTypeForm(props: Props) {
	...
	const { mutate: createFn, isLoading: isCreating } = useCreateCategoryType();
	const { mutate: updateFn, isLoading: isUpdating } = useUpdateCategoryType();
	const { data } = useGetCategoryTypeDetail({
		id: props.id || "",
